...
<template>
    <nav class="fixed top-2 z-50 flex w-full justify-center">
        <div
            ...
            <span class="font-serif text-xl font-bold">OC/二创</span>
    ...
    <header class="relative flex h-dvh w-full items-center justify-center">
        <div
            class="flex h-full w-full flex-col items-center justify-center gap-6"></div>
    </header>

    <main
        class="grid auto-rows-[20em] grid-cols-2 gap-4 p-4 xl:grid-cols-4"></main>
