...
<template>
    ...
    <header class="relative flex min-h-dvh w-full items-center justify-center">
        <div class="flex flex-wrap items-center gap-20">
            <div class="flex flex-col gap-2 font-serif font-bold select-none">
                <h1 class="text-primary text-7xl/20">
                    Together Building <br />
                    <span class="text-theme text-shadow-lg">
                        The Best Place
                    </span>
                    <br />
                    For HTUers
                ...
                <div>
                    <span class="text-lg"
                        >为
                        <span class="bg-primary text-background px-2"
                            >河南师范大学学生</span
                        >
                        打造的专属工具站，现已开源登场。</span
                    >
                </div>
            </div>
            <div>
                <img
                    class="w-150 rounded-lg bg-[url('./assets/pad-border.png')] bg-cover"
                    src="./assets/pad-border.png"
        ...
        <!-- Direction -->
        <div
            class="bg-background border-secondary absolute bottom-2 animate-pulse rounded-xl border-2 p-2 shadow-lg">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="30"
                height="30"
